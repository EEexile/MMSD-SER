...
from model import MMERModel as EnhancedMMERModel
...
def parse_args():
    ...
    parser.add_argument(
        "--test_csv",
        type=str,
        default="data/meld_processed/test/meld_test.csv",
    )
    parser.add_argument(
        "--test_audio",
        type=str,
        default="data/meld_processed/test/wavs",
    )
    parser.add_argument(
        "--baseline_ckpt",
        type=str,
    ...
    parser.add_argument(
        "--enhanced_ckpt",
        type=str,
        default="checkpoints/meld_stage2/meld_best_soft_model.pt",
    )
