...
def main():
    ...
    parser.add_argument('--train_csv_hard', type=str, default='data/meld_processed/train/meld_train.csv')
    parser.add_argument('--train_csv_soft', type=str, default='data/aug_meld_processed/train/meld_train_augmented.csv')
    parser.add_argument('--train_soft_labels', type=str, default='meld_soft_labels_dir/meld_aug_soft_labels.npz')
    
    parser.add_argument('--train_audio_hard', type=str, default='data/meld_processed/train/wavs')
    parser.add_argument('--train_audio_soft', type=str, default='data/aug_meld_processed/train/wavs')
    
    parser.add_argument('--dev_csv', type=str, default='data/meld_processed/dev/meld_dev.csv')
    parser.add_argument('--dev_audio', type=str, default='data/meld_processed/dev/wavs')
    
    parser.add_argument('--test_csv', type=str, default='data/meld_processed/test/meld_test.csv')
    parser.add_argument('--test_audio', type=str, default='data/meld_processed/test/wavs')
    ...
    parser.add_argument('--teacher_model', type=str, default='checkpoints/meld_stage1/meld_best_model.pt')
