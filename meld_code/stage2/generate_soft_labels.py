...
def main():
    ...
    parser.add_argument('--model_path', type=str, 
                        default='/mnt/cxh10/database/lizr/MELD_mmer/MELD_2026-04-10_10-41-40/meld_best_model.pt',
                        help='Path to the trained MELD best model')
    # 默认指向增强后的 train CSV
    parser.add_argument('--csv_path', type=str, 
                        default='/mnt/cxh10/database/lizr/MELD_mmer/data/aug_meld_processed/train/meld_train_augmented.csv',
                        help='Path to the augmented data CSV file')
    # 默认指向生成的增强 wav 文件夹
    parser.add_argument('--audio_dir', type=str, 
                        default='/mnt/cxh10/database/lizr/MELD_mmer/data/aug_meld_processed/train/wavs',
    ...
    parser.add_argument('--device', type=str, default='cuda:0',  # 默认改回常用单卡
