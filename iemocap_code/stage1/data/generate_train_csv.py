...
def main():
    ...
    LABEL_PATH = "/mnt/cxh10/database/lizr/MMER3/feats/train.emo"
    OUTPUT_CSV = "/mnt/cxh10/database/lizr/MMER3/feats/train.csv"
    ...
    print(f"加载了 {len(utt_to_emotion)} 个情感标签")

    # 2. 读取文本转录（使用字符串分割，非正则）
    utt_to_text = {}
    ...
    if missing_text > 0:
        print(f"⚠ 警告: {missing_text} 个 utterance 缺少文本")
